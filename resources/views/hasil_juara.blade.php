...
@section('content')
    ...
    <div class="bg-white p-4 md:p-6 rounded-lg shadow-md">
        ...
        <a href="{{ route('export.hasil_excel', $kompetisi->id) }}" target="_blank"
            class="inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 ml-2">
            Export Excel
        </a>
