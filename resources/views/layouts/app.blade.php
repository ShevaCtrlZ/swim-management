...
<body class="bg-gray-100 font-sans antialiased">
    <div class="flex h-screen overflow-hidden">
        ...
        <!-- Sidebar -->
        <aside id="sidebar"
            class="fixed z-40 inset-y-0 left-0 w-64 bg-white shadow-md transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0">
            ...
            <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                @if (auth()->check() && auth()->user()->role === 'klub')
                    <a href="{{ route('info.klub') }}"
                        class="flex items-center p-2 text-gray-700 rounded hover:bg-gray-100">
