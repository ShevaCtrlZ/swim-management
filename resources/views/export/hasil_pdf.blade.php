                    ...
                    <tbody>
                        @foreach ($item->detailLomba->sortBy(function($d) {
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="border border-gray-300 px-4 py-2">{{ $peserta->peserta->nama_peserta ?? '-' }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $peserta->peserta->tgl_lahir ?? '-' }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $peserta->peserta->asal_klub ?? '-' }}</td>
